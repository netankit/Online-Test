...
--
-- Host: localhost
-- Generation Time: Jan 18, 2012 at 02:11 PM
...
INSERT INTO `2001A` (`ansid`, `quesid`, `answer`, `points`, `collid`, `studid`, `date`) VALUES
(1, 1, 'C', 1, '9999', 24, '11/01/2012'),
(2, 2, 'A', 0, '9999', 24, '11/01/2012'),
(3, 3, 'linux', 0, '9999', 24, '11/01/2012'),
(4, 1, 'A', 0, '112', 23, '11/01/2012'),
(5, 2, 'A', 1, '112', 23, '11/01/2012'),
(6, 3, 'linu', 0, '112', 23, '11/01/2012'),
(7, 1, 'C', 1, '112', 26, '11/01/2012'),
(8, 2, 'A', 1, '112', 26, '11/01/2012'),
(9, 3, 'LINUX', 1, '112', 26, '11/01/2012');
...
--
-- Table structure for table `3001`
--

CREATE TABLE IF NOT EXISTS `3001` (
  `qid` bigint(100) NOT NULL AUTO_INCREMENT,
  `ques` text NOT NULL,
  `op1` varchar(255) DEFAULT NULL,
  `op2` varchar(255) DEFAULT NULL,
...
--
-- Dumping data for table `3001`
--

INSERT INTO `3001` (`qid`, `ques`, `op1`, `op2`, `op3`, `op4`, `mcq`) VALUES
(1, 'What is the mailing software for google?', '', '', '', '', 'n');

-- --------------------------------------------------------

--
-- Table structure for table `3001A`
--

CREATE TABLE IF NOT EXISTS `3001A` (
  `ansid` bigint(100) NOT NULL AUTO_INCREMENT,
  `quesid` bigint(100) NOT NULL,
  `answer` text NOT NULL,
  `points` bigint(10) NOT NULL,
...
--
-- Dumping data for table `3001A`
--

INSERT INTO `3001A` (`ansid`, `quesid`, `answer`, `points`, `collid`, `studid`, `date`) VALUES
(1, 1, 'Google Test', 1, '9999', 24, '13/01/2012'),
(2, 1, 'Gmail', 1, '112', 23, '13/01/2012');

-- --------------------------------------------------------

--
-- Table structure for table `3001_ans`
--

CREATE TABLE IF NOT EXISTS `3001_ans` (
  `qid` bigint(100) NOT NULL,
  `answer` text NOT NULL,
  PRIMARY KEY (`qid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
--
-- Dumping data for table `3001_ans`
--

INSERT INTO `3001_ans` (`qid`, `answer`) VALUES
(1, 'Gmail');
...
CREATE TABLE IF NOT EXISTS `college` (
  `cno` bigint(100) NOT NULL AUTO_INCREMENT,
  `collid` varchar(100) NOT NULL,
...
INSERT INTO `college` (`cno`, `collid`, `cname`) VALUES
(1, '112', 'Indian Institute of Technology, Bombay'),
(2, '9999', 'Admin College'),
(3, 'RAJ-001', 'Arya College of Engineering and I.T, Kukas');
...
CREATE TABLE IF NOT EXISTS `reviewed` (
  `tno` bigint(50) NOT NULL AUTO_INCREMENT,
  `tid` bigint(50) NOT NULL,
  `date` varchar(50) NOT NULL,
  `collid` varchar(50) NOT NULL,
  PRIMARY KEY (`tno`)
...
INSERT INTO `testscore` (`scoreid`, `date`, `collid`, `studid`, `tid`, `score`) VALUES
(367, '11/01/2012', '112', 26, 2001, 3),
(366, '11/01/2012', '112', 23, 2001, 1),
(365, '11/01/2012', '112', 26, 2001, 3),
(364, '11/01/2012', '112', 23, 2001, 1);
